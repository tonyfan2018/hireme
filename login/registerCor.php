...
<html>
    <head>
      ...
      <body>
        ...
        <section class="regiCor-page">
            <div class="regiCor-form">

            <form method="post" enctype="multipart/form-data" action="processRegisCor.php">
              <div>
                  Name: <input type="text" name="corName" />
                  Email: <input type="email" name="corEmail" />
                  password: <input type="password" name="corPassword" />
                  Address: <input type="text" name="corAddress" />
                  </div>
                  <div>
                  Avatar(Only ".jpg" file):<input type="file" name="userfile" /> 
                  Introduction: <br><textarea name="corIntro" rows="10" cols="38" required></textarea><br />
              </div>
